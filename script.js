...
const translations = {
    en: {
        ...
        'exp-role': 'Volunteer',
        'exp-org': 'Ministry of Higher Education',
        'exp-dept': 'ICT Directory, System Department',
        'exp-desc': 'Volunteered at the Ministry of Higher Education, contributing to ICT projects and system development initiatives.',
    ...
    ku: {
        ...
        'exp-role': 'بەشداری داواکارانە',
        'exp-org': 'وەزارەتی پەروەردەی بالا',
        'exp-dept': 'بەشی ICT و بەشی سیستەم',
        'exp-desc': 'بەشداری داواکارانەم کرد لە وەزارەتی پەروەردەی بالا، بەشداریم کرد لە پڕۆژەکانی ICT و هەوڵدانی پەرەپێدانی سیستەم.',
